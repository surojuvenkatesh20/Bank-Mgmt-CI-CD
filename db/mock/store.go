...
// Source: github.com/surojuvenkatesh20/bank-mgmt/db/sqlc (interfaces: Store)
...
func (m *MockStore) TransferTx(arg0 context.Context, arg1 db.TransferTxRequest) (db.TransferTxResponse, error) {
	m.ctrl.T.Helper()
